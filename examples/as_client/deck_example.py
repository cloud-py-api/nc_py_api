...
try:
    ...
    card2 = nc.deck.create_card(
        board_id=test_board.board_id, stack_id=todo_stack.stack_id, title="Test Card 2: Simple task", order=1
    )
    ...
    retrieved_card = nc.deck.get_card(board_id=test_board.board_id, stack_id=todo_stack.stack_id, card_id=card1.card_id)
    ...
    card3 = nc.deck.create_card(
        board_id=test_board.board_id, stack_id=todo_stack.stack_id, title="Test Card 3: Third task", order=0
    )
    card4 = nc.deck.create_card(
        board_id=test_board.board_id, stack_id=todo_stack.stack_id, title="Test Card 4: Fourth task", order=1
    )
    ...
    nc.deck.delete_card(board_id=test_board.board_id, stack_id=todo_stack.stack_id, card_id=card2.card_id)
