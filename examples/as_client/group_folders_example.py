...
if nc.group_folders.available:
    ...
    nc.group_folders.set_permissions(folder_id=new_folder.folder_id, group_id="developers", permissions=FULL_ACCESS)
    print(f"Set full access for 'developers' group")

    nc.group_folders.set_permissions(folder_id=new_folder.folder_id, group_id="viewers", permissions=READ_WRITE)
    ...
    nc.group_folders.set_acl_permission(
        folder_id=new_folder.folder_id, mapping_id="admin", mapping_type="user", permissions=FULL_ACCESS
    )
    ...
    nc.group_folders.remove_acl_permission(folder_id=new_folder.folder_id, mapping_id="admin", mapping_type="user")
