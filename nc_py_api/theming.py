...
def _convert_str_color(theming_capability: dict, key: str) -> tuple[int, int, int]:
...
def _get_parsed_theme(theming_capability: dict) -> ThemingInfo:
    ...
    return ThemingInfo(
        ...
        url=i["url"],
        slogan=i["slogan"],
        color=_convert_str_color(i, "color"),
        color_text=_convert_str_color(i, "color-text"),
        color_element=_convert_str_color(i, "color-element"),
        color_element_bright=_convert_str_color(i, "color-element-bright"),
        color_element_dark=_convert_str_color(i, "color-element-dark"),
        logo=i["logo"],
